...
<body>
	...
	<section id="container">
		<form action="" method="post">
 			...
 			<table>
 			<tr>
                 <th><a href="../sqlite/import.php?tienda=<?php echo $select_id; ?>" class="btn_new"> <i class="fas fa-cash-register"></i> Actualizar Precios</a></th>
 				 <th>
                ...
                <th><a href="genera_txt_balanza.php?tienda=<?php echo $select_id; ?>" class="btn_new" > <i class="fas fa-balance-scale-right"></i> Generar Archivo p/ Balanzas</a></th>
		...
		<div>
			<?php
			//Listar Articulos de la tienda seleccionada
